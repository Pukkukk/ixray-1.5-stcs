...
const s64		DEFAULT_CLIENT_ID	= 1548611865137909800ll;
LPCSTR			DEFAULT_LARGE_IMAGE	= "csga_dirt_skull";	// the mod's own logo, uploaded as an Art Asset
LPCSTR			DEFAULT_LARGE_TEXT	= "S.T.A.L.K.E.R.: Clear Sky";
...
bool CDiscordRPC::Connect()
{
	...
	params.client_id	= (DiscordClientId)_atoi64(cfg_string("client_id", "1548611865137909800"));
