...
extern ECORE_API float			ps_r2_sun_depth_far_scale;	// 1.0f
extern ECORE_API float			ps_r2_sun_depth_far_bias;	// 0.0f
extern ECORE_API float			ps_r2_sun_depth_near_scale;	// 1.0f
extern ECORE_API float			ps_r2_sun_depth_near_bias;	// 0.0f
